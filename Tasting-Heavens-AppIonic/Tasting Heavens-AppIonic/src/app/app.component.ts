...
export class MyApp {
  ...
  pagesRestaurant: Array<{title:string, component:any}>;
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      { title: 'Home', component: TabsUser },
      { title: 'Settings', component: SettingUserPage },
      { title: 'Logout', component: HomePage }
    ];

    this.pagesRestaurant = [
      { title: 'Home', component: TabsRestaurant },
      { title: 'Settings', component: SettingUserPage },
      { title: 'Logout', component: HomePage }
    ];
  }
